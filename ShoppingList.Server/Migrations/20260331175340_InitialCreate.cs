    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopListUser", x => new { x.ShopListsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ShopListUser_ShopLists_ShopListsId",
                        column: x => x.ShopListsId,
                        principalTable: "ShopLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopListUser_Users_UsersId",
                        column: x => x.UsersId,
